---
url: https://inertia-rails.dev/guide/asset-versioning.md
---
# Asset Versioning
...
---
url: https://inertia-rails.dev/guide/authentication.md
---
# Authentication
...
---
url: https://inertia-rails.dev/guide/authorization.md
---
# Authorization
...
---
url: https://inertia-rails.dev/awesome.md
---
...
---
url: https://inertia-rails.dev/guide/cached-props.md
---
# Cached Props
...
---
url: https://inertia-rails.dev/guide/caching.md
---
# Caching
...
---
url: https://inertia-rails.dev/guide/client-side-setup.md
---
# Client-Side Setup
...
---
url: https://inertia-rails.dev/guide/code-splitting.md
---
# Code Splitting
...
---
url: https://inertia-rails.dev/guide/configuration.md
---
# Configuration
...
---
url: https://inertia-rails.dev/guide/csrf-protection.md
---
# CSRF Protection
...
---
url: https://inertia-rails.dev/guide/deferred-props.md
---
# Deferred Props
...
---
url: https://inertia-rails.dev/guide/demo-application.md
---
# Demo Application
...
## Inertia 1.x-2.x Demo App

The previos demo app for Inertia.js is called [Ping CRM](https://demo.inertiajs.com). This application is built using Laravel and Vue. You can find the source code on [GitHub](https://github.com/inertiajs/pingcrm).
...
| [Ruby on Rails/Vue SSR/Vite](https://github.com/ElMassimo/pingcrm-vite) | Máximo Mussini    |
...
---
url: https://inertia-rails.dev/guide/error-handling.md
---
# Error Handling
...
---
url: https://inertia-rails.dev/guide/events.md
---
# Events
...
This event will *not* fire for XHR requests that receive `400` and `500` level responses or for non-Inertia responses, as these situations are handled in other ways by Inertia. Please consult the [error handling documentation](/guide/error-handling) for more information.
...
In addition to the global events described throughout this page, Inertia also provides a number of [event callbacks](/guide/manual-visits#event-callbacks) that fire when manually making Inertia visits.

---

---
url: https://inertia-rails.dev/guide/file-uploads.md
---
# File Uploads
...
---
url: https://inertia-rails.dev/guide/flash-data.md
---
# Flash Data
...
---
url: https://inertia-rails.dev/guide/forms.md
---
# Forms
...
You can set default values for form inputs using standard HTML attributes. Use `defaultValue``defaultValue``defaultValue` (`value` for Svelte < `5.6.0`) for text inputs and textareas, and `defaultChecked``defaultChecked``defaultChecked` (`checked` for Svelte < `5.6.0`) for checkboxes and radios.
...
<template>
  <Form
    ...
    :options="{
      preserveScroll: true,
      preserveState: true,
      preserveUrl: https://inertia-rails.devtrue,
      replace: true,
      only: ['users', 'flash'],
      except: ['secret'],
      reset: ['page'],
...
When setting the `disableWhileProcessing``disableWhileProcessing``disable-while-processing` prop, the `Form` component will add the `inert` attribute to the HTML `form` tag while the form is processing to prevent user interaction.
...
> \[!NOTE]
> Both the `<Form>` component and `useFormContext` accept generic type parameters for type-safe errors and slot props. See the [TypeScript](/guide/typescript#form-component) documentation for details.

### Precognition

@available\_since core=2.3.0
...
The submit methods support all of the typical [visit options](/guide/manual-visits), such as `preserveState`, `preserveScroll`, and event callbacks, which can be helpful for performing tasks on successful form submissions. For example, you might use the `onSuccess` callback to reset inputs to their original state.
...
For a more thorough discussion of form validation and errors, please consult the [validation documentation](/guide/validation).
...
If you're using client-side input validation libraries or do client-side validation manually, you can set your own errors on the form using the `setError()` method.
...
If your form's default values become outdated, you can use the `defaults()``setDefaults()``defaults()` method to update them. Then, the form will be reset to the correct values the next time the `reset()` method is invoked.
...
To instruct Inertia to store a form's data and errors in [history state](/guide/remembering-state), you can provide a unique form key as the first argument when instantiating your form.
...
Both the `<Form>` component and `useForm` helper support optimistic updates, allowing you to update the UI immediately before the server responds. For more details, see the [optimistic updates](/guide/optimistic-updates) documentation.
...
---
url: https://inertia-rails.dev/cookbook/handling-validation-error-types.md
---
...
---
url: https://inertia-rails.dev/guide/history-encryption.md
---
# History Encryption
...
---
url: https://inertia-rails.dev/guide/how-it-works.md
---
# How it works
...
To learn more about the nitty-gritty, technical details of how Inertia works under the hood, check out the [protocol page](/guide/the-protocol).

---

---
url: https://inertia-rails.dev/guide/http-requests.md
---
# HTTP Requests
...
---
url: https://inertia-rails.dev/cookbook/inertia-modal.md
---
# Inertia Modal
...
---
url: https://inertia-rails.dev/guide/starter-kits.md
---
...
---
url: https://inertia-rails.dev/guide/infinite-scroll.md
---
# Infinite Scroll
...
---
url: https://inertia-rails.dev/guide/instant-visits.md
---
# Instant Visits
...
---
url: https://inertia-rails.dev/cookbook/integrating-shadcn-ui.md
---
...
---
url: https://inertia-rails.dev/guide.md
---
...
---
url: https://inertia-rails.dev/guide/layouts.md
---
# Layouts
...
---
url: https://inertia-rails.dev/guide/links.md
---
# Links
...
---
url: https://inertia-rails.dev/guide/load-when-visible.md
---
# Load When Visible
...
---
url: https://inertia-rails.dev/guide/manual-visits.md
---
# Manual Visits
...
router.visit(url, {
  ...
  fresh: false,
  reset: [],
  preserveUrl: https://inertia-rails.devfalse,
  prefetch: false,
...
router.push({
  url: https://inertia-rails.dev'/users',
  component: 'Users',
  props: { search: 'John' },
  clearHistory: false,
...
router.push({ url: https://inertia-rails.dev'/users', component: 'Users' })
...
---
url: https://inertia-rails.dev/guide/merging-props.md
---
# Merging Props
...
---
url: https://inertia-rails.dev/guide/once-props.md
---
# Once Props
...
---
url: https://inertia-rails.dev/guide/optimistic-updates.md
---
# Optimistic Updates
...
---
url: https://inertia-rails.dev/guide/pages.md
---
# Pages
...
`app/frontend/pages/users/show.vue`
`app/frontend/pages/users/show.jsx`
`app/frontend/pages/users/show.svelte` within a Rails application.
...
---
url: https://inertia-rails.dev/guide/partial-reloads.md
---
# Partial Reloads
...
---
url: https://inertia-rails.dev/guide/polling.md
---
# Polling
...
---
url: https://inertia-rails.dev/guide/prefetching.md
---
# Prefetching
...
---
url: https://inertia-rails.dev/guide/progress-indicators.md
---
# Progress Indicators
...
---
url: https://inertia-rails.dev/guide/redirects.md
---
# Redirects
...
@available\_since rails=3.19.0 core=3.0.0
...
---
url: https://inertia-rails.dev/guide/remembering-state.md
---
# Remembering State
...
---
url: https://inertia-rails.dev/guide/responses.md
---
# Responses
...
---
url: https://inertia-rails.dev/guide/routing.md
---
# Routing
    ...
    render inertia: {
      users: User.all.map do |user|
        user.as_json(
          ...
          edit_url: https://inertia-rails.devedit_user_path(user)
        )
      end,
      create_url: https://inertia-rails.devnew_user_path
    }
  end
end
```
...
---
url: https://inertia-rails.dev/guide/scroll-management.md
---
# Scroll Management
...
---
url: https://inertia-rails.dev/cookbook/server-managed-meta-tags.md
---
...
---
url: https://inertia-rails.dev/guide/server-side-rendering.md
---
...
You should also update your `inertia.js` file to use hydration instead of normal rendering. This allows VueReactSvelte to pick up the server-rendered HTML and make it interactive without re-rendering it.
...
---
url: https://inertia-rails.dev/guide/server-side-setup.md
---
# Server-Side Setup
...
---
url: https://inertia-rails.dev/guide/shared-data.md
---
# Shared Data
...
---
url: https://inertia-rails.dev/guide/testing.md
---
# Testing
...
---
url: https://inertia-rails.dev/guide/the-protocol.md
---
# The Protocol
...
---
url: https://inertia-rails.dev/guide/title-and-meta.md
---
# Title & Meta
...
---
url: https://inertia-rails.dev/guide/typescript.md
---
# TypeScript
...
router.push<UserPageProps>({
  ...
  url: https://inertia-rails.dev'/users/1',
...
---
url: https://inertia-rails.dev/guide/upgrade-guide.md
---
...
---
url: https://inertia-rails.dev/guide/validation.md
---
# Validation
...
First, you [submit your form using Inertia](/guide/forms). If there are server-side validation errors, you don't return those errors as a `422` JSON response. Instead, you redirect (server-side) the user back to the form page they were previously on, flashing the validation errors in the session.
...
When validation errors occur, the user is typically redirected back to the form page they were previously on. And, by default, Inertia automatically preserves the [component state](/guide/manual-visits#state-preservation) for `post`, `put`, `patch`, and `delete` requests. Therefore, all the old form input data remains exactly as it was when the user submitted the form.
...
---
url: https://inertia-rails.dev/guide/view-transitions.md
---
# View Transitions
...
---
url: https://inertia-rails.dev/guide/who-is-it-for.md
---
