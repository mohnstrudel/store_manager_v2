...
ShopifyApp.configure do |config|
  ...
  config.scope = "read_products, write_products, read_orders, read_order_edits, read_customers, read_inventory, write_images, read_files, write_files, read_payment_terms, read_locations"
