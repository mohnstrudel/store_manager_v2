...
class ColorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create color" do
    assert_difference("Color.count") do
      post colors_url, params: { color: { form: @color.form, franchise: @color.franchise, size: @color.size, supplier: @color.supplier, version: @color.version } }
    end
  ...
  test "should update color" do
    patch color_url(@color), params: { color: { form: @color.form, franchise: @color.franchise, size: @color.size, supplier: @color.supplier, version: @color.version } }
