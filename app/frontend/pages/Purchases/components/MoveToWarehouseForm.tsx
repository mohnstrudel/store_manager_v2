...
export default function MoveToWarehouseForm({
  ...
  return (
    <div
      className={fixed ? "move_to_warehouse__form fixed bottom-4 inset-x-2 mx-auto z-228 backdrop-blur-xl shadow-xl rounded-xl border border-gray-100 p-4 dark:border-gray-800 lg:bottom-8 lg:inset-x-0 lg:p-8 lg:w-4/5" : "mb-4"}
    >
      <form
      ...
      >
        ...
        <button className="btn-rounded btn-blue h-11 w-full lg:w-auto" type="submit">
          <i className="icn">🚚</i>
          Move
