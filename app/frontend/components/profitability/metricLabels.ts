...
export const financialMetricHints = {
  ...
  grossRevenue:
    "The full value we expect to collect once every payment is billed, before any cost is taken out.",
  monthlyRevenue:
    "The full value of sales created in this month, whether or not customers have paid yet.",
  netProfit: "Gross revenue minus Purchase cost, Purchase expenses, and Estimated OpEx.",
  potentialSales:
    "What every purchased unit will earn at its variant's selling price, before any costs. Sold and unsold units alike.",
  purchaseCost: "What the suppliers charged for the items, before shipping and any other cost.",
  purchaseExpenses:
    "Every other cost of the purchased items: inbound shipping and direct expenses.",
