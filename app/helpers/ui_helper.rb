...
module UiHelper
  ...
  def fetch_btn_for(record, path: nil)
    button_to(path || polymorphic_path([record, :pull]), class: "btn_rounded", method: :post) do
  ...
  def destroy_btn_for(record)
    ...
    button_to text,
      ...
      method: :delete,
      class: "btn_red w-full h-12 mt-16 btn_rounded",
